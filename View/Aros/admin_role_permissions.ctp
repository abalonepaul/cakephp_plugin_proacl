                ...
                foreach ($roles as $role) {
                    ...
                    if (isset(
                        ...
                        if ($method['permissions'][$role[$roleModelName][$rolePkName]] == 1) {
                            // echo '<td>' .
                            // $this->Html->link($this->Html->image('/acl/img/design/tick.png'),
                            // '/admin/acl/aros/deny_role_permission/' .
                            // $role[$roleModelName][$rolePkName] .
                            // '/plugin:' . $plugin_name . '/controller:' .
                            ...
                            // echo '<td>' .
                            // $this->Html->link($this->Html->image('/acl/img/design/cross.png'),
                            // '/admin/acl/aros/grant_role_permission/' .
                            // $role[$roleModelName][$rolePkName] .
                            // '/plugin:' . $plugin_name .'/controller:' .
                            // $plugin_ctrler_name . '/action:' .
                            // $method['name'], array('escape' => false)) .
